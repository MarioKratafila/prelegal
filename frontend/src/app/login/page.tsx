    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold" style={{ color: "#032147" }}>Welcome back</h1>
          <p className="text-sm mt-1" style={{ color: "#888888" }}>Sign in to continue drafting your legal documents</p>
        </div>
